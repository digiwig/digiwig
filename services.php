...
<body id="services" ontouchstart="">
    ...
    <main id="main">
        ...
        <section id="what">
            ...
            <p>I design and develop bespoke websites and provide a range of online support services for organisations large and small.</p>
        </section>
        <section id="boxes">
            <figure id="web">
                    ...
                    <article><p>Like it says on the tin, I build websites and web applications, for all businesses of all types and sizes. A network of associates and I collaborate across projects and all avenues of design and development. If you have a design, or even an idea, send it my way and I'll provide an altogether excellent service.</p></article>
          </figure>
            <figure id="seo">
                    <img width="auto" height="auto" src="_/images/seo.png" alt="Web"/>
                    <h3>SEO</h3>
                    <figcaption>Visibility, Strategy, Presence</figcaption>                    
                    <article><p>I know the tricks of the trade. Search engines are constantly updating their algorithms. I work full time within this industry, so let me help you gain better visibility on the web.</p></article>
          </figure>
            <figure id="support">
                    <img width="auto" height="auto" src="_/images/support.png" alt="Web"/>
                    <h3>Support</h3>
                    <figcaption>Reliable, Dependable, Reponsive</figcaption>
                    <article><p>Offering professional support on all aspects of web development. Whether that be debugging issues or monthly updates to your website, with a support contract problems are addressed quickly and effectively. A contract can be designed to suit your business and your needs, or you may choose to pay as you go.</p></article>
          </figure>
            <figure id="apps">
                    <img width="auto" height="auto" src="_/images/applications.png" alt="Web"/>
                    <h3>Apps</h3>
                    <figcaption>Bespoke, Secure, Efficient</figcaption>
                    <article><p>Application development can be a wash out of different ideas merging all into a single function of pointlessness without a clearly defined set of goals and requirements. UX Design and information architecture are integral fields of research and development, and are vital in delivering practical and feasible functionality. Sound understanding stems a sophisticated product. Get your application off to the right start and get in touch.</p></article>
            </figure>         
        </section>
        <section id="rates">
        	<h2>How Much Do I Cost?</h2>
